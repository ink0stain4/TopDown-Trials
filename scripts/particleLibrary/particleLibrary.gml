...
part_type_gravity(_ptype3_trail, 0.1, 270);
...
part_type_alpha3(_ptype3_trail, 1, 1, 0);
...
part_type_life(_ptype6, 30, 40);
part_type_speed(_ptype6, 2, 4, 0, 0);
part_type_direction(_ptype6, 0, 180, 0, 0)
part_type_gravity(_ptype6, 0.2, 270);
part_type_size(_ptype6, 1, 2, -0.005, 0.001);
